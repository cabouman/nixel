...
MODELS_DIR = os.path.join(HERE, "models")     # saved decoders (.linrd)
RECONS_DIR = os.path.join(HERE, "recons")     # saved reconstructions (.linrz)
RUNS_DIR = os.path.join(HERE, "runs")         # per-experiment run dirs (configs, checkpoints, figures)
